...
## Project Structure
    ...
    ├── testapiautoteammemb_56776  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_56776`
...
2. Clone this repo and `cd testapiautoteammemb_56776`
